public class Main {
	public static void main(String []args) {
		...
		System.out.println( fullname(((("XDA").startsWith("XD")) ?surname() + cond_repeat(fullname(((("XDA").startsWith("XD")) ?"kappa":"pepega")," ",surname()) + cond_repeat("yes",fullname(((("XDA").startsWith("XD")) ?"kappa":"pepega")," ",surname())) + findLangType("Typescript"),fullname(((("XDA").startsWith("XD")) ?"kappa":"pepega")," ",surname())):"pepega")," ",surname()));
		System.out.println( cond_repeat("yes",fullname(((("XDA").startsWith("XD")) ?"kappa":"pepega")," ",surname())));
		System.out.println( findLangType("Typescript"));
		System.out.println( cond_repeat(fullname(((("XDA").startsWith("XD")) ?"kappa":"pepega")," ",surname()) + cond_repeat("yes",fullname(((("XDA").startsWith("XD")) ?"kappa":"pepega")," ",surname())) + findLangType("Typescript"),fullname(((("XDA").startsWith("XD")) ?"kappa":"pepega")," ",surname())));
